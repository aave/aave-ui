...
export type GovernanceProposalsSubscription = { __typename?: 'Subscription' } & {
  proposals: Array<
...
export type GetVoteByUserQuery = { __typename?: 'Query' } & {
  vote?: Maybe<
    { __typename?: 'Vote' } & Pick<
      Vote,
      'voter' | 'id' | 'support' | 'votingPower' | 'timestamp'
...
export type GetTopVotersSubscription = { __typename?: 'Subscription' } & {
  votes: Array<
    { __typename?: 'Vote' } & Pick<Vote, 'voter' | 'support' | 'votingPower' | 'id' | 'timestamp'>
  >;
};
