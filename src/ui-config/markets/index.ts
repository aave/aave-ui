...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  ...
  [CustomMarket.proto_arbitrum_rinkeby]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0xA82E5f120A2E3dd38A79136cb26452ea1Cf8e46f'.toLowerCase(),
      LENDING_POOL: '0xF667C61EEbB0F2Dd010E1540d9dAdAB2990E1DaF',
      WETH_GATEWAY: '0x17f402240D5eC153d11F0A5988c390a9B677fEd1',
      FAUCET: '0xFF8933402A1Ef9A352E8A0F57a66DDE4E43be559',
      WALLET_BALANCE_PROVIDER: '0x4C839A90B7C798aDd73cfba4Dd978feA6E7ac1a3',
      UI_POOL_DATA_PROVIDER: '0x81Fd371819261dBA28cC5D31DBfaAed7dAb1E0cD',
      UI_INCENTIVE_DATA_PROVIDER: '0xa18C6553E93C0Ca1ccc796008Af597cE2d53128c',
    },
  },
} as const;
