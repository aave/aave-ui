...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  ...
  //   },
  //   addresses: {
  //     LENDING_POOL_ADDRESS_PROVIDER: '0xa1cdAe5C138dCfEc77EF49811d56deEc5C5F84d2'.toLowerCase(),
  //     LENDING_POOL: '0xABE8AB3d7002A777CF9Eb0C19D77fB01740847D8',
  //     WETH_GATEWAY: '0xe3B35df5516C5bb1ea57489c556bef320C935B36',
  //     FAUCET: '0x35EbECB9a021c003c21DB6d45D7E2838ea5C614E',
  //     WALLET_BALANCE_PROVIDER: '0x279f6EF634B3c6A166D3C5c8F6D44F52ec0aE85b',
  //     UI_POOL_DATA_PROVIDER: '0x06ec6B005D23268a88E9ED109DcA1809B1eC0572',
  //     UI_INCENTIVE_DATA_PROVIDER: '0x48D1b09f1B3210E2f28b16a8f7aa0a6aDEB031E4',
  //   },
  // },
  [CustomMarket.proto_fantom_testnet]: {
    ...
    addresses: {
      ...
      LENDING_POOL: '0xE05dce1f07Fdc4Bd4326437248855b3Fa6D05631',
      WETH_GATEWAY: '0x56fC5d9667cb23f045846BE6147a052FdDa26A99',
      FAUCET: '0x02444D214962eC73ab733bB00Ca98879efAAa73d',
      WALLET_BALANCE_PROVIDER: '0x9BBA071d1f2A397Da82687e951bFC0407280E348',
      UI_POOL_DATA_PROVIDER: '0xA702C5Fe370734D38060621e05215C70e0A6939E',
      UI_INCENTIVE_DATA_PROVIDER: '0x63F0F2d9C338cA14ffb6D611df7d62710D13EBEF',
    },
  },
