...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  ...
  [CustomMarket.proto_arbitrum_rinkeby]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x9AB5EC42fC6A12b1A8D902Fd2f4Efae59982bfdb'.toLowerCase(),
      LENDING_POOL: '0x6fC20aBE2d45E584a3436d52b70e876B32c67942',
      WETH_GATEWAY: '0x16cB4B1c85791D60cc6537d6aC10148CE358e3cC',
      FAUCET: '0x067b0f20fB84cec0585ac2c4565367484c79c61B',
    },
  },
} as const;
