...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  [CustomMarket.proto_kovan_v3]: {
    ...
    addresses: {
      ...
      WALLET_BALANCE_PROVIDER: '0xc4dCB5126a3AfEd129BC3668Ea19285A9f56D15D',
      UI_POOL_DATA_PROVIDER: '0x478C4A82a830fc1a855622C85585342975CF0b68',
      UI_INCENTIVE_DATA_PROVIDER: '0x4026fF2EDf3fd688811f02907Bf69a0dd7e57C05',
    },
  },
