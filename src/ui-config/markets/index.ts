...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  ...
  [CustomMarket.proto_arbitrum_rinkeby]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x050169e297BaD80c3bD11758f6BAA4e1497F70B7'.toLowerCase(),
      LENDING_POOL: '0x3517eb675A265F06e4e8e62edCfEa8AE979635fb',
      WETH_GATEWAY: '0xa09B20d8fdDBEB9BBa34DfE84AA5C5d43F2B6aF4',
      FAUCET: '0xDE4800a987ab36909f82B5856DE8e81B533cDa7f',
    },
  },
} as const;
