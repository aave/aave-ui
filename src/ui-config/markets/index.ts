...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  ...
  [CustomMarket.proto_arbitrum_rinkeby]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x2815dB9253018f2fc74Ad48394f1a547727F8aD4'.toLowerCase(),
      LENDING_POOL: '0x1605BaDE436A45FA62b30E40508B3b2E921D99bC',
      WETH_GATEWAY: '0x4B284B0cEE25FEDe0D7D3a4D86DF934Fa65615f2',
      FAUCET: '0x762D81FAcC6DbcA5D7df842c64D3d8E23cEC3B08',
      WALLET_BALANCE_PROVIDER: '0xaCEA55A27D5dFA32528Ff5df274e25Dc3cC0c8c3',
      UI_POOL_DATA_PROVIDER: '0x6f45F156B570d49c198d44A5A5c44064d2Cda922',
