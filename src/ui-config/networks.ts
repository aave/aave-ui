...
const mainnet_config: BaseNetworkConfig = {
  ...
  cachingServerUrl: 'http://localhost:3000/graphql', //'https://cache-api-mainnet.aave.com/graphql',
  cachingWSServerUrl: 'ws://localhost:3000/graphql', //'wss://cache-api-mainnet.aave.com/graphql',
