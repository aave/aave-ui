...
export default defineMessages({
  ...
  usageOfCollateralDescription: 'You have chosen that this asset be used/not be used as collateral',
  liquidationDescription: 'Your position has been liquidated',

  amount: 'Amount',
  liquidationAmount: 'Debt covered',
