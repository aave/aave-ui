  ...
  let sortedData = reserves
    ...
    .map((reserve) => {
      ...
      return {
        ...
        aincentivesAPR: reserveIncentiveData ? reserveIncentiveData.aIncentives[0].incentiveAPR : '0',
        vincentivesAPR: reserveIncentiveData ? reserveIncentiveData.vIncentives[0].incentiveAPR : '0',
        sincentivesAPR: reserveIncentiveData ? reserveIncentiveData.sIncentives[0].incentiveAPR : '0',
