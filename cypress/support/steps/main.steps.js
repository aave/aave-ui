...
module.exports.borrow = ({asset, amount, apyType, hasApproval = true}, skip, updateSkipStatus = false) =>{
  let _shortName =asset.shortName;
  let _fullName =asset.fullName;
    ...
    it(`Choose ${repayOption} repay option`, ()=>{
      switch(repayOption) {
        case constants.repayType.collateral:
          cy.get('.ButtonLink')
            .contains('With your current collateral')
            .click()
          break;
        case constants.repayType.wallet:
          cy.get('.ButtonLink')
            .contains('From your wallet balance')
            .click()
          break;
